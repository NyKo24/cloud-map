...
final class Version20260324150000 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE iam_role (id INT AUTO_INCREMENT NOT NULL, crawl_id INT NOT NULL, role_name VARCHAR(255) DEFAULT NULL, role_id VARCHAR(255) DEFAULT NULL, arn VARCHAR(2048) DEFAULT NULL, path VARCHAR(512) DEFAULT NULL, create_date DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, max_session_duration INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_IAMROLE_CRAWL (crawl_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE iam_user (id INT AUTO_INCREMENT NOT NULL, crawl_id INT NOT NULL, user_name VARCHAR(255) DEFAULT NULL, user_id VARCHAR(255) DEFAULT NULL, arn VARCHAR(2048) DEFAULT NULL, path VARCHAR(512) DEFAULT NULL, create_date DATETIME DEFAULT NULL, password_last_used DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_IAMUSER_CRAWL (crawl_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
